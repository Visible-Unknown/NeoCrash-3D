...
taught in the course — perspective projection, lighting, collision detection, and
real-time rendering.
...
We extended the game significantly with features that were **not part of the
original task** — to make it more engaging, polished, and technically rich:
